...
public class Evento implements Serializable {
    ...
    @Column(name = "Aforo")
    private int aforo;
    @JoinTable(name = "personaevento", joinColumns = {
        @JoinColumn(name = "NombreEvento", referencedColumnName = "Nombre")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "practica1_ejercicio2_p.Evento[ nombre=" + nombre + " ]";
    }
