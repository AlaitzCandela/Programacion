...
public class TablaAbogado {
    ...
    public boolean BorrarCliente(Abogado a) throws Exception{
    ...
    public Abogado [] Consulta(String nombre,String dato) throws Exception{
    String plantilla="";   
     plantilla="SELECT * FROM abogado WHERE lower("+nombre+")=?;";
     PreparedStatement ps=con.prepareStatement(plantilla);
     ps.setString(1,dato);
     ...
     public Abogado [] ConsultaI(String nombre,int dato) throws Exception{
    String plantilla="";   
     plantilla="SELECT * FROM abogado WHERE lower("+nombre+")=?;";
     PreparedStatement ps=con.prepareStatement(plantilla);
     ps.setInt(1,dato);
